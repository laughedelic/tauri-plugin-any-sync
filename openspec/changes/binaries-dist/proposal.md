...
- Add `links = "any_sync_go"` to plugin's `Cargo.toml` to enable metadata propagation
...
- Add Cargo features for selective platform binary downloads (`all-platforms`, `desktop-only`, platform-specific features)
