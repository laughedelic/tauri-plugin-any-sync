...
- [x] 1.7 Implement Delete method in storage wrapper with idempotent behavior
- [x] 1.8 Add unit tests for delete operation (existing document, non-existent document)
...
- [x] 2.6 Add delete command handler in `src/commands.rs`
- [x] 2.7 Add gRPC Delete client call in `src/desktop.rs`
- [x] 2.8 Add integration tests for delete operation (idempotency, error cases)
...
- [x] 3.5 Add delete function to `guest-js/index.ts` with DeleteResult type
- [x] 3.6 Add JSDoc documentation for delete operation explaining idempotency
...
- [x] 4.7 Add UI for deleting documents with feedback (existed vs not found)
- [x] 4.8 Update storage demo to demonstrate full CRUD cycle
- [x] 4.9 Add visual indication of document lifecycle (create → update → delete)
